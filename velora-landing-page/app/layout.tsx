...
})(window,document,'script','dataLayer','GTM-THTDPBTH');`,
          }}
        />
        <Script
          id="meta-pixel"
...
fbq('track', 'PageView');`,
      ...
      >
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-THTDPBTH"
            height="0"
            width="0"
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=1473996924499831&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        {children}
