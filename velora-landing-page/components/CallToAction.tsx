...
const CallToAction = ({
  ...
  return (
    <section
      className={cn(
        "relative isolate overflow-hidden px-6 py-16 text-white sm:px-10 sm:py-24",
    ...
    >
      ...
      <div className="relative mx-auto flex max-w-4xl flex-col items-center text-center gap-6 sm:gap-8">
        ...
        <Button
          asChild
          size="lg"
          className="mt-2 rounded-full bg-white text-foreground text-base sm:text-lg font-semibold shadow-lg px-6 sm:px-8 py-6 hover:bg-white hover:translate-y-0.5 transition"
        >
